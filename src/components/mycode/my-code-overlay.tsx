      ...
      <div className="relative mx-auto flex h-full max-w-sm flex-col justify-center px-4 py-6">
        <div className="rounded-[32px] bg-white/95 p-5 shadow-2xl backdrop-blur-md">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xl font-semibold text-ink">{t.my_qr_code}</p>
              <p className="mt-1 text-sm text-black/50">{t.show_scan_qr}</p>
            </div>
            <button
              type="button"
              onClick={onClose}
              aria-label={t.close_my_code}
