...
function GoogleIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="h-7 w-7">
      ...
      />
      <path fill="#EA4335" d="M3.85 7.59l3.17 2.32C7.84 8.1 9.84 6.79 12.17 6.79c1.82 0 3.04.77 3.74 1.43l2.55-2.46C17.6 4.17 15.4 3.02 12.17 3.02c-2.98 0-5.51 1.56-8.32 4.57Z" />
      <path fill="#4285F4" d="M12.17 21.98c3.15 0 5.8-1.04 7.73-2.82l-3.57-2.93c-.95.66-2.22 1.15-4.16 1.15-3.57 0-5.04-2.79-5.28-4.25L3.63 15.5c1.62 3.2 4.95 6.48 8.54 6.48Z" />
      <path fill="#34A853" d="M21.35 11.1h-9.18v2.98h5.28c-.16 1.02-.8 2.45-2.16 3.52l3.57 2.93c2.06-1.91 3.24-4.76 3.24-7.46 0-.62-.07-1.09-.01-1.58Z" />
    </svg>
  );
}
